/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: b9d5017769acee277eac0cae80781a4d)
...
declare namespace Cloudflare {
	interface Env {
		...
		DB: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* odds-dashboard */;
		ASSETS: Fetcher;
	}
}
